...
1. Enter your package name. The name you choose should contain your default organization followed by the name you typed. For example: `FirstLightGames9Ad7d6dcE4674628Adec8954Dcbaabe5.NotificationService`.
...
To use the Inspector, select the `package.json` file in the Project browser. The **Package Notification Service Manifest** page opens for editing.
...
Use the `Documentations~/Notification Service.md` documentation file to create preliminary, high-level documentation. This document should introduce users to the features and sample files included in your package.  Your package documentation files will be used to generate online and local docs, available from the Package Manager UI.
